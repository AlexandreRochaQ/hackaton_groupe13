      ...
      <div className="max-w-2xl mx-auto relative">
        ...
        {pageDragging && !uploading && (
          <div className="fixed inset-0 bg-brand-500/10 border-2 border-dashed border-brand-500 z-50 flex flex-col items-center justify-center gap-4 pointer-events-none">
            ...
            <p className="text-brand-400 font-semibold text-lg">Relâchez pour ajouter vos documents</p>
          </div>
        )}

        <div className="mb-8">
          <h1 className="text-2xl font-bold text-white">Déposer des documents</h1>
        ...
        {files.length > 0 && (
          <div className="mt-6">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-6 py-3.5 bg-brand-500 hover:bg-brand-600 disabled:bg-brand-500/40 text-white font-semibold rounded-xl text-sm shadow-sm transition-colors"
            >
              <Sparkles size={16} />
